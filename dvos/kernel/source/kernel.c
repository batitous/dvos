...
KMemory * defaultMemory;        /**< default memory space for kernel */
...
KThread * newThread( void (*userCode)(void), UInt32 stackSize, UInt8 cpuTime, UInt8 priority)
{
    // alloc thread structure :
...
void initKernel(void)
{
    ...
    idleThread = newThread( &idleThreadCode, IDLE_STACK, IDLE_CPU, IDLE_PRIORITY);
